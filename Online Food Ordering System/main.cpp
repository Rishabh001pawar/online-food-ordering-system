...
int main () {
char name[30], pizza1[] = " Fazita", pizza2[] =
"Chicken Bar BQ", pizza3[] = "Peri Peri", pizza4[] = "Creamy Max", roll1[] =
" Chatni Roll", roll2[] = "veg Mayo Roll", roll3[] =
"Veg Roll With Fries", bur1[] = "Zinger Burger", bur2[] =
"Chicken Burger", bur3[] = "Beef Burger";

char sand1[] = "Club Sandwich", sand2[] =
	" Crispy Sandwich", sand3[] = "Extream Veg Sandwich";

char bir1[] = "Chicken Biryani", bir2[] = " Biryani", bir3[] =
	"veg Biryani", gotostart;

int choice = 0, pchoice, pchoice1, quantity;	// time=40;
beginning:
system ("CLS");

cout << "\t\t\t----------Btech Fast Food wala-----------\n\n";
...
cout <<
				"\n\nThank you For Ordering From Btech Fast Food Wala\n";
